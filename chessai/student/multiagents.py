...
class ReflexAgent(chessai.agents.greedy.GreedyAgent):
    """
    A simple agent based on chessai.agents.greedy.GreedyAgent.

    You job is to make this agent better (it is pretty bad right now).
    You can change whatever you want about it,
    but it should still be a child of chessai.agents.greedy.GreedyAgent
    ...
    def evaluate_state(self,
        ...
        return super().evaluate_state(state, action, **kwargs)

class MyMinimaxLikeAgent(chessai.agents.minimax.MinimaxLikeAgent):
    """
